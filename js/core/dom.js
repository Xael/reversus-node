...
export const showHandButton = document.getElementById('show-hand-button');
...
// Hand Overlay
export const handOverlay = document.getElementById('hand-overlay');
export const cardFan = document.getElementById('card-fan');
